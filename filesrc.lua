...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Huhhhhuhhh700 chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "Huhhhhuhhh700", HidePremium = false, IntroText = "Huhhhhuhhh700⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("Huhhhhuhhh700 SCRIPT")
W:AddLabel("DiscordHuhhhhuhhh700")
local Section = W:AddSection({
    Name = "Status"
})
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Huhhhhuhhh700(Noitification)",
